...
class type browser_window =
  object
    ...
    method setAlwaysOnTop :
      bool t -> js_string t Optdef.t -> int Optdef.t -> unit meth
    ...
    method webContents : WebContents.t Js.readonly_prop
  end
...
class type options =
  object
    method width : int Optdef.t Js.readonly_prop

    method height : int Optdef.t Js.readonly_prop

    method x : int Optdef.t Js.readonly_prop

    method y : int Optdef.t Js.readonly_prop

    method useContentSize : bool t Optdef.t Js.readonly_prop

    method center : bool t Optdef.t Js.readonly_prop

    method minWidth : int Optdef.t Js.readonly_prop

    method minHeight : int Optdef.t Js.readonly_prop

    method maxWidth : int Optdef.t Js.readonly_prop

    method maxHeight : int Optdef.t Js.readonly_prop

    method resizable : bool t Optdef.t Js.readonly_prop

    method movable : bool t Optdef.t Js.readonly_prop

    method minimizable : bool t Optdef.t Js.readonly_prop

    method maximizable : bool t Optdef.t Js.readonly_prop

    method closable : bool t Optdef.t Js.readonly_prop

    method focusable : bool t Optdef.t Js.readonly_prop

    method alwaysOnTop : bool t Optdef.t Js.readonly_prop

    method fullscreen : bool t Optdef.t Js.readonly_prop

    method fullscreenable : bool t Optdef.t Js.readonly_prop

    method simpleFullscreen : bool t Optdef.t Js.readonly_prop

    method skipTaskbar : bool t Optdef.t Js.readonly_prop

    method kiosk : bool t Optdef.t Js.readonly_prop

    method title : js_string t Optdef.t Js.readonly_prop

    method show : bool t Optdef.t Js.readonly_prop

    method frame : bool t Optdef.t Js.readonly_prop

    method parent : browser_window t Optdef.t Js.readonly_prop

    method modal : bool t Optdef.t Js.readonly_prop

    method acceptFirstMouse : bool t Optdef.t Js.readonly_prop

    method disableAutoHideCursor : bool t Optdef.t Js.readonly_prop

    method autoHideMenuBar : bool t Optdef.t Js.readonly_prop

    method enableLargerThanScreen : bool t Optdef.t Js.readonly_prop

    method backgroundColor : js_string t Optdef.t Js.readonly_prop

    method hasShadow : bool t Optdef.t Js.readonly_prop

    method opacity : float Optdef.t Js.readonly_prop

    method darkTheme : bool t Optdef.t Js.readonly_prop

    method transparent : bool t Optdef.t Js.readonly_prop

    method _type : js_string t Optdef.t Js.readonly_prop

    method titleBarStyle : js_string t Optdef.t Js.readonly_prop

    method fullscreenWindowTitle : bool t Optdef.t Js.readonly_prop

    method thickFrame : bool t Optdef.t Js.readonly_prop

    method vibrancy : js_string t Optdef.t Js.readonly_prop

    method zoomToPageWidth : bool t Optdef.t Js.readonly_prop

    method tabbingIdentifier : js_string t Optdef.t Js.readonly_prop
  end
