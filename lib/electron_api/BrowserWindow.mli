...
val all :
  < _BrowserWindow :
      Electron_plumbing.BrowserWindow.singleton Js.t Js.readonly_prop
  ; .. >
  Js.t ->
  t list
...
val aspect_ratio :
  ?extra_size:Electron_plumbing.Struct.Size.t -> t -> float -> unit
...
val content_bounds :
  ?animate:bool -> t -> Electron_plumbing.Struct.Rectangle.t -> unit
